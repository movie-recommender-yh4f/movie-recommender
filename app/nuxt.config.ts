...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    platformAiProviderMode: process.env.NUXT_PLATFORM_AI_PROVIDER_MODE ?? 'live',
    platformAiMockEnabled: process.env.NUXT_PLATFORM_AI_MOCK_ENABLED === 'true',
    platformAiMockScenario: process.env.NUXT_PLATFORM_AI_MOCK_SCENARIO ?? 'success-normal',
    platformAiMockDelayMs: process.env.NUXT_PLATFORM_AI_MOCK_DELAY_MS ?? '',
    loadTestEnabled: process.env.NUXT_LOAD_TEST_ENABLED === 'true',
    loadTestToken: process.env.NUXT_LOAD_TEST_TOKEN ?? '',
    loadTestEnvironment: process.env.NUXT_LOAD_TEST_ENVIRONMENT ?? 'unknown',
